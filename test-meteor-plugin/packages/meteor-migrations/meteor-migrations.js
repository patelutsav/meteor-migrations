...
export const Migrations = {
    ...
    _findVersionsToExecute: function (versions) {
    ...
    _insertSuccessfullyRanMigration: function (migration, rerun) {
        ...
        if (rerun) {
            ...
            this._listCollection.insert(data);
        }
    },
    ...
    migrateTo: function (command) {
        ...
        if (command === 'latest') {
            versionsToExecute = this._findVersionsToExecute(this._list.map(item => item.version));
